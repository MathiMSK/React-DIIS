            ...
            i ? (
              ...
              >
                ...
                <Col  style={{ marginTop: "2px",padding:"5px",marginLeft:"2px" }}>
                  <ArgonTypography style={{ fontSize: "35px" }}>
                    {index + 1}.
                  </ArgonTypography>
                  </Col>
                ...
                <FormControl style={{ margin: "1%" }}>
                  ...
                  <FormControlLabel
                      ...
                      label={i?.options[0]?.optionAns==i?.answer ? (<Fragment>{i?.options[0]?.optionAns}<CheckCircleSharpIcon color="success"/></Fragment>):(<Fragment>{i?.options[0]?.optionAns}<HighlightOffSharpIcon color="secondary"/></Fragment>)} 
                    ...
                    <FormControlLabel
                      ...
                      control={<BpRadio />}
                       ...
                       label={i?.options[1]?.optionAns==i?.answer ? (<Fragment>{i?.options[1]?.optionAns}<CheckCircleSharpIcon color="success"/></Fragment>):(<Fragment>{i?.options[1]?.optionAns}<HighlightOffSharpIcon color="secondary"/></Fragment>)} 
                       />
                    <FormControlLabel
                      value={i?.options[2]?.optionAns}
                      control={<BpRadio />}
                      disabled={i?.options[2]?.optionAns!==answerData.answers[index].answer}
                      label={i?.options[2]?.optionAns==i?.answer ? (<Fragment>{i?.options[2]?.optionAns}<CheckCircleSharpIcon color="success"/></Fragment>):(<Fragment>{i?.options[2]?.optionAns}<HighlightOffSharpIcon color="secondary"/></Fragment>)} 
                    />
                    <FormControlLabel
                      value={i?.options[3]?.optionAns}
                      control={<BpRadio />}
                      disabled={i?.options[3]?.optionAns!==answerData.answers[index].answer}
                      label={i?.options[3]?.optionAns==i?.answer ? (<Fragment>{i?.options[3]?.optionAns}<CheckCircleSharpIcon color="success"/></Fragment>):(<Fragment>{i?.options[3]?.optionAns}<HighlightOffSharpIcon color="secondary"/></Fragment>)} 
                    />
